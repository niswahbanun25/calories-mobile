...
class DashboardActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        binding.apply {
            ...
            dashboardItemAdapter.onItemDeleteClick = { dashboardItem ->
                ...
                with(builder) {
                    setTitle("Warning !")
                    setMessage("Are you sure you want to delete ${dashboardItem.meal} by the number of calories ${dashboardItem.amount}?")
    ...
    private fun updateTotalCals(dashboardItemList: List<DashboardItem>?) {
